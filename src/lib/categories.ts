...
export const CATEGORY_IMAGES: Record<CategorySlug, string> = {
  ...
  AC_TECHNICIAN: "https://images.unsplash.com/photo-1545649311-24d0ac00ae82?w=800&q=80",
  ...
  MASON: "https://images.unsplash.com/photo-1704005445445-2747074be8ac?w=800&q=80",
}
